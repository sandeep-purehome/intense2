...
<html lang="en">
	...
	<body id="home">
		...
		<footer class="container-fluid container-section">
			<div class="row quick-contact headings-main">
			...
			<div class="row">
				<div class="col-md-4">
					<h1 class="headings-sub">Social Media</h1>
				...
				<div class="col-md-4">
					<h1 class="headings-sub"><i class="fa fa-newspaper-o fa-lg"></i> Newsletter</h1>
				...
				<div class="col-md-4">
					<h1 class="headings-sub">Quick Links</h1>
					<div class="row">
						<div class="col-md-6">
